    ...
    sources: [
      {
        ...
        fields: { parcel_id: ['PARCEL_NO'], use_code: false, use_description: false },
        ownerCompose: { org: 'ORG_NAME', last: 'LAST_NAME', first: 'FIRST_NAME' },
        notes: 'County parcels with owner name parts (no pagination support; the app pages by object id). Values and land use come from the State join.',
      },
      {
